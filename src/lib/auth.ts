 ...
 * - Email/senha habilitado com verificação obrigatória via Better Auth.
 * - O envio do link de verificação é entregue pelo Resend, encapsulado
 *   em `src/lib/email/resend.ts`.
