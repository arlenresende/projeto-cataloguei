      ...
      <div className="mx-auto max-w-6xl px-4">
        ...
        <div className="mt-14 grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                {[
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className="size-9 rounded-md bg-indigo-100" />
                      <div>
          ...
          <article className="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
            ...
            <div className="bg-gradient-to-b from-indigo-50/40 to-white p-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  { name: "Fone Pro", price: "R$ 299", tone: "from-indigo-100 to-indigo-50" },
                  { name: "Mouse Gamer", price: "R$ 159", tone: "from-emerald-100 to-emerald-50" },
                ].map((item) => (
                  <div
                    key={item.name}
              ...
              <div className="mt-4 rounded-lg bg-emerald-500 px-3 py-2 text-center text-xs font-semibold text-white">
